      ...
      <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          >
            ...
            >
              <h4 className="font-semibold text-white mb-3 text-lg">Want to Submit Your CV?</h4>
              <p className="text-white/80 text-sm mb-4">
                For CV/Resume submissions and document reviews, please email us directly with your documents attached.
              </p>
              <div className="flex items-center space-x-2 text-white/90">
                <HiMail className="w-4 h-4" />
                <span className="text-sm font-medium">info@volksways.com</span>
              </div>
            </motion.div>
          </motion.div>
        </div>
